...
function () {
  ...
  _regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51MbL8EKH1cPkuYbBfSUzN9ecysdLfOw60Exz4FiGj0BDQwlzy1CLzenXnts5hat8stYyCTLuje8rcZXA6WqXrR6H00r0zFfRv1');
          _context.prev = 1;
          _context.next = 4;
